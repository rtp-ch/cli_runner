...
// This file was generated on 2013-04-23 18:10

$extensionPath = t3lib_extMgm::extPath('rtp_cli');
$extensionClassesPath = t3lib_extMgm::extPath('news') . 'Classes/';
require_once(t3lib_extMgm::extPath('rtp_cli') . 'Classes/Cache/ClassCacheBuilder.php');
